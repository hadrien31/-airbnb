...
jungle = Adventure.create(user: user1, title: 'Jungle Book', location: 'Pandora', decription: 'Dans le monde extraterrestre luxuriant de Pandora vivez comme  les Navi, des êtres qui semblent primitifs, mais qui sont très évolués..', price: 34000, duration: "7 days")
...
island = Adventure.create(user: user1, title: 'Fantastic Island', location: 'Thailande', decription: 'Vivez une expérience unique et découvrez une autre vision du voyage, durable et engagée.', price: 34000, duration: "7 days" )
...
desert = Adventure.create(user: user1, title: 'Desert Experience', location: 'Merzouga', decription: "Faire l'expérience d'un trek dans le désert, c'est vivre des moments uniques et privilégiés au cœur de la nature et de la culture ..", price: 34000, duration: "7 days")
...
mountain = Adventure.create(user: user1, title: 'Mountain Exploration', location: 'Tyrol', decription: 'Se la jouer Mike Horn en stage de survie ', price: 34000, duration: "7 days")
